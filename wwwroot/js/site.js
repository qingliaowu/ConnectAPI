...
var ccpUrl = "https://villagegroup.awsapps.com/connect/ccp#/";
...
function callNumber() {
    const endpoint = this.connect.Endpoint.byPhoneNumber("+529983718976");// номер искходящего вызова 
    window.myCPP.agent.connect(endpoint,
        {
            success: () => { console.log('success') },
            failure: () => { console.log('failures') }
        })
}
